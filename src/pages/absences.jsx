...
const AbsencesPage = () => {
  ...
  const { houseOptions, loading: loadingHouses } = useHouses();
    ...
    <div className="flex flex-col gap-4 text-black">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button
          ...
          width="w-full sm:w-auto" height="h-[42px]" textSize="text-sm"
      ...
      <EmployeeFilters
        ...
        searchPlaceholder="Nombre del empleado"
        activeFilter={filterDeleted}
        setActiveFilter={setFilterDeleted}
        statusLabel="Filtrar por estado"
        statusOptions={DELETED_OPTIONS}
      >
        <SelectField
          label="Filtrar por Casa Hogar"
          name="filter-house"
          value={filterHouseId}
          onChange={(e) => setFilterHouseId(e.target.value)}
          options={loadingHouses ? [] : houseOptions}
          placeholder={loadingHouses ? "Cargando casas..." : "Todas las casas"}
        ...
        renderRow={(absence, i) => (
          <EmployeeRow
            ...
            cells={[
              ...
              { key: "house", content: absence.employee?.house  ?? "—", className: "text-[#666666]" },
