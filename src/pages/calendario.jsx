            ...
            >
                {
                    ...
                    selectedDates && (
                        <p>
                            ...
                            }/${selectedDates.startDate.getUTCFullYear()} ${selectedDates.startDate.getUTCHours()}:${selectedDates.startDate.getUTCMinutes()}:${selectedDates.startDate.getUTCSeconds()} a ${selectedDates.endDate.getUTCDate()}/${
                                selectedDates.endDate.getUTCMonth() + 1
                            }/${selectedDates.endDate.getUTCFullYear()} ${selectedDates.endDate.getUTCHours()}:${selectedDates.endDate.getUTCMinutes()}:${selectedDates.endDate.getUTCSeconds()}`}
                        </p>
                    )
                }
            </Modal>
