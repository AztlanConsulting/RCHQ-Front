...
export const workdayUpdateSchema = z
    .object({
        ...
        start: z
            .string()
            .regex(TIME_REGEX, "Formato HH:MM requerido para el inicio"),
        end: z
            .string()
            .regex(TIME_REGEX, "Formato HH:MM requerido para el fin"),
    })
...
export const employeeAdminUpdateSchema = z
    .object({
        houseId: z
            .string()
            .uuid("El houseId debe ser un UUID válido")
            .optional(),
        roleId: z.string().uuid("El roleId debe ser un UUID válido").optional(),

        type: z
            .enum(["Nomina", "Asalariado", "Honorarios", "Voluntariado"], {
        ...
        workdays: z
            .array(workdayUpdateSchema)
            .min(1, "Debe incluir al menos un día")
            .optional(),
    })
    .strict()
    .refine(
    ...
    .refine(
        ...
        {
            message: "El salario debe ser mayor a 0 para este tipo de contrato",
            path: ["salary"],
        },
    );
