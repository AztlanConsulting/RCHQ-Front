    ...
    default: (props) => {
        ...
        return (
            <div data-testid="full-calendar">
                <button onClick={props.customButtons.toggleListButton.click}>
                    Lista
                </button>
                <button onClick={props.customButtons.monthButton.click}>
                    Mes
                </button>
                <button onClick={props.customButtons.weekButton.click}>
                    Semana
                </button>
                <button onClick={props.customButtons.dayButton.click}>
                    Día
                </button>
                <button
                    onClick={() =>
                        props.eventClick?.({ event: { id: "evt-1" } })
                    }
                >
                    Abrir evento
                </button>
...
vi.mock("../../components/molecules/calendarCards/dayGridCard", () => ({
    default: () => <div>DayGridCard</div>,
}));
vi.mock("../../components/molecules/calendarCards/dayGridOverflowCard", () => ({
    default: () => <div>Overflow</div>,
}));
vi.mock("../../components/molecules/calendarCards/weekTimeCard", () => ({
    default: () => <div>WeekTimeCard</div>,
}));
vi.mock("../../components/molecules/calendarCards/dayTimeCard", () => ({
    default: () => <div>DayTimeCard</div>,
}));
vi.mock("../../components/molecules/calendarCards/listEventCard", () => ({
    default: () => <div>ListEventCard</div>,
}));
