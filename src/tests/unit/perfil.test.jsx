...
describe("perfil.jsx", () => {
  ...
  describe("Estado de carga", () => {
    it("muestra el skeleton mientras carga", () => {
      ProfileService.getUserData.mockReturnValue(new Promise(() => {}));
  ...
  describe("Flujo exitoso", () => {
    it("muestra el título 'Mi Perfil'", async () => {
      ProfileService.getUserData.mockResolvedValue(PROFILE_DATA);
      render(<Perfil />);
      await waitFor(() => {
  ...
  describe("Funcionalidad de reintento", () => {
    it("llama a ProfileService.getUserData de nuevo al hacer clic en Reintentar", async () => {
      const err = Object.assign(new Error("Server error"), { status: 501 });
