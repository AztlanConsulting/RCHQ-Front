...
describe("Integración: Calendario page", () => {
  ...
  it("orquesta filtros, calendario y carga inicial de la page", () => {
    ...
    expect(screen.getByTestId("calendar-filters")).toHaveTextContent("Operaciones CDMX");
    expect(screen.getByTestId("calendar-filters")).toHaveTextContent("Coordinador");
    expect(screen.getByTestId("base-calendar")).toHaveTextContent("Eventos: 1");
  });
