  ...
  return (
    ...
    >
      <div className="flex items-center h-16 shrink-0">
        ...
        >
          <ExpandIcon
            className={`h-5 w-5 text-[#FAFAFA] transition-transform duration-300 ${expanded ? "rotate-180" : ""}`}
          />
        </button>
        <span
          className={`
    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#1F3664] shadow-[0_0_8px_0_rgba(0,0,0,0.8)]">
        <div className="flex items-center h-14 px-4">
          ...
          <span className="flex-1 text-center font-['Public_Sans'] font-bold text-xl text-[#FAFAFA]">
            TOCHAN R.H.
          </span>
        </div>
              ...
              >
                {({ isActive }) => (
                  <>
                    ...
                    <span className="font-['Public_Sans'] font-bold text-base text-[#FAFAFA]">
                      {label}
                    </span>
                  </>
                )}
