...
const tabItemStyles = {
  underline: {
    base: "relative z-10 whitespace-nowrap px-0.5 pb-2.5 pt-0 text-xl sm:text-3xl font-normal tracking-tight border-b-2 transition duration-100 cursor-pointer",
