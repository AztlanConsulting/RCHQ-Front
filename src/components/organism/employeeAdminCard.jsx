        ...
        <div className="basis-2/3 rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="flex justify-between items-start">
                ...
                {isEditing ? (
                    ...
                    <button
                        type="button"
                        aria-label="Editar información administrativa"
            ...
            {saveError && isEditing && (
                <p className="mt-2 text-sm text-red-600 bg-red-50 rounded-lg px-4 py-2">
                    {saveError}
                </p>
            )}
            ...
            {!isEditing && (
                <div className="mt-4 w-full flex flex-col gap-4">
                    ...
                    <Drawer
                        isOpen={workdaysDrawer.isOpen}
                        className={workdaysDrawer.isOpen ? "mt-1" : ""}
                    >
                        <div className="flex flex-col gap-1">
                            {employeeWorkdays?.length > 0 &&
                                employeeWorkdays.map((w) => (
                                    <div
                                        key={w.workdayId}
                    ...
                    <div className="mt-4 flex flex-col gap-4">
                        <div className="grid grid-cols-2 gap-4">
                            <SelectField
                                ...
                                onChange={(e) =>
                                    setAdminField("houseId", e.target.value)
                                }
                            ...
                            <SelectField
                                ...
                                onChange={(e) =>
                                    setAdminField("roleId", e.target.value)
                                }
                                options={roles.map((r) => ({
                                    value: r.roleId,
                                    label: r.name,
                            ...
                            <SelectField
                                ...
                                onChange={(e) =>
                                    setAdminField("type", e.target.value)
                                }
                                options={TIPOS}
