                ...
                {!isEditing && (
                    <>
                            ...
                            {[
                                { label: "Puesto", value: employee?.role },
                                {
                                    ...
                                    value: employee?.birthDate
                                        ? String(employee.birthDate).slice(
                                              0,
                                              10,
                                          )
                                        : null,
                                },
                                {
                                    ...
                                    value: employee?.startDate
                                        ? String(employee.startDate).slice(
                                              0,
                                              10,
                                          )
                                        : "Sin fecha",
                        ...
                        <Drawer
                            ...
                            className={infoDrawer.isOpen ? "mt-2" : ""}
                        >
