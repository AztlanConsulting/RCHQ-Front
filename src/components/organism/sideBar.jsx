...
const Icon = ({ name, className }) => (
    <img src={`/${name}.svg`} alt="" aria-hidden="true" className={className} />
);
        ...
        <>
            ...
            <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#1F3664] shadow-[0_0_8px_0_rgba(0,0,0,0.8)]">
                <div className="flex items-center h-14 px-4">
                    ...
                    <span
                        aria-hidden="true"
                        className="flex-1 text-center font-['Public_Sans'] font-bold text-xl text-[#FAFAFA]"
                    >
                        TOCHAN
                    </span>
                </div>
                            ...
                            >
                                {({ isActive }) => (
                                    <>
                                        ...
                                        <span
                                            aria-hidden="true"
                                            className="font-['Public_Sans'] font-bold text-base text-[#FAFAFA]"
                                        >
                                            {label}
                                        </span>
                                    </>
...
// ─── Root SideBar ─────────────────────────────────────────────────────────────
const SideBar = () => {
    const { expanded, toggle, mobileOpen, openMobile, closeMobile } =
        useSideBar();
